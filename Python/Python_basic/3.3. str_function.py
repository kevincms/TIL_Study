...
print("%d."%count,test_str,len(test_str)) # 1. 문자열 길이 반환
count+=1

print("%d."%count,test_str.upper()) # 2. 대문자로 변경
count+=1

print("%d."%count,test_str.lower()) # 3. 소문자로 변경
count+=1

print("%d."%count,test_str[0].isupper()) # 4. 대문자 확인
count+=1

print("%d."%count,test_str[0].islower()) # 5. 소문자 확인
count+=1
